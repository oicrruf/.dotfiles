...
brew "btop"                   # Interactive resource monitor (modern htop)
brew "chafa"                  # Terminal graphics provider
brew "cloudflared"            # Cloudflare Tunnel client
brew "colima"                 # Container runtime (Docker & K8s)
...
brew "mu-repo"                # Tool for managing multiple git repositories
brew "neovim"                 # Hyperextensible Vim-based text editor
brew "openconnect"            # VPN client compatible with Cisco AnyConnect
