# Generated by Powerlevel10k configuration wizard on 2026-02-04 at 08:24 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_TRUNCATION_LENGTH=1
  typeset -g POWERLEVEL9K_DIR_STRATEGY=truncate_to_last
  typeset -g POWERLEVEL9K_DIR_ANCHORS_HELPER=false
...
typeset -g POWERLEVEL9K_DIR_SHORTENED_CONTEXT_REPLACEMENT=''
typeset -g POWERLEVEL9K_DIR_CONTENT_EXPANSION='%B%F{blue}%~%f%b'
typeset -g POWERLEVEL9K_DIR_ANCHOR_FILES=()
